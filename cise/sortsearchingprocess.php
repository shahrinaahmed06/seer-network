    ...
    <body>
        ...
        <?php
	        ...
	        if (!$conn) {
		        ...
		        $query = "select source, title, author, published_year, technique, link from seer where technique like '".$technique."'
				   AND published_year BETWEEN '".$published_year1."' AND '".$published_year2."'";
		        ...
		        if(!$result) {
			        ...
			        echo "<table border=\"1\">";
			        echo "<tr>\n"
				        ."<th scope=\"col\"><a href='sortsearchingprocess.php?sort=source'>Source</a></th>\n"
			            ."<th scope=\"col\"><a href='sortsearchingprocess.php?sort=technique'>Technique</a></th>\n"
				        ."<th scope=\"col\"><a href='sortsearchingprocess.php?sort=title'>Title</a></th>\n"
				        ."<th scope=\"col\"><a href='sortsearchingprocess.php?sort=author'>Author</a></th>\n"
				        ."<th scope=\"col\"><a href='sortsearchingprocess.php?sort=link'>DOI</a></th>\n"
			            ."<th scope=\"col\"><a href='sortsearchingprocess.php?sort=published_year'>Year</a></th>\n"
				        ."</tr>\n;
				    <tr>\n";
